            ...
            <CardContent className="pt-4 pb-4">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">未完结订单预付费用</p>
                </div>
            ...
            <CardContent className="pt-4 pb-4">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-xl font-semibold mt-0.5 text-green-600">
                    ¥{stats.actualRevenue.toLocaleString()}
                  </p>
                  <p className="text-xs text-gray-500 mt-0.5">已完结订单收款</p>
                </div>
                <TrendingUp className="w-7 h-7 text-green-500 flex-shrink-0" />
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="pt-4 pb-4">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">实际收款 - 应付账款</p>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <Card>
            <CardContent className="pt-4 pb-4">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  <p className="text-xs text-gray-600">应付账款（分销）</p>
                  <p className="text-xl font-semibold mt-0.5 text-orange-600">
                    ¥{stats.payableDistribution.toLocaleString()}
                  </p>
                  <p className="text-xs text-gray-500 mt-0.5">应结算的佣金</p>
                </div>
                <DollarSign className="w-7 h-7 text-orange-500 flex-shrink-0" />
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="pt-4 pb-4">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-xl font-semibold mt-0.5 text-purple-600">
                    ¥{stats.payableSupplier.toLocaleString()}
                  </p>
                  <p className="text-xs text-gray-500 mt-0.5">应结算的成本价</p>
                </div>
